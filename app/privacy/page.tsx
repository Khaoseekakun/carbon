      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">ข้อมูลที่เราเก็บรวบรวม</p>
            <ul className="list-disc pl-6 mb-4">
              <li>ข้อมูลที่ท่านกรอกในแบบฟอร์มคำนวณ (เช่น ประเภทการเดินทาง การใช้พลังงาน หรือกิจกรรมที่เกี่ยวข้องกับการปล่อยคาร์บอน)</li>
              <li>วันที่และเวลาที่ท่านเข้าชมเว็บไซต์</li>
              <li>สถิติโดยรวมเกี่ยวกับการใช้งาน</li>
            </ul>

            <p className="mb-4">วัตถุประสงค์ในการใช้ข้อมูล</p>
            <ul className="list-disc pl-6 mb-4">
              <li>วิเคราะห์ผลการคำนวณคาร์บอนฟุตพริ้นท์โดยรวมของผู้ใช้งาน</li>
              <li>ใช้เป็นข้อมูลประกอบในการจัดทำโครงงานการศึกษาเพื่อเสนอต่อวิทยาลัยเทคนิคเชียงใหม่</li>
              <li>สถิติโดยรวมเกี่ยวกับการใช้งาน</li>
            </ul>
          </section>
