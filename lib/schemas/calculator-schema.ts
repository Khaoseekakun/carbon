...
export const calculatorFormSchema = z.object({
  ...
  home_garbage_is_thrown_away: z.number().min(1, { message: 'กรุณาระบุปริมาณการทิ้งขยะ' }),
  home_wood_burning_frequency: z.number().min(1, { message: 'กรุณาระบุปริมาณการทิ้งขยะ' }),
  ...
  motorcycle_brand: z.string().min(1, { message: 'กรุณาระบุยี่ห้อรถมอเตอร์ไซค์' }).optional(),
